...
export const PAGE_FAQS: FAQ[] = [
  {
    ...
    answer: 'We aim to respond to <a href="/services/emergency-drain-services/" class="text-primary hover:underline">emergency drainage callouts</a> within 60-90 minutes across <a href="/locations/aldershot/" class="text-primary hover:underline">Aldershot</a> and Hampshire. Our team operates around the clock, so help is available whenever you need it, day or night.'
  },
  {
    question: "Do you charge a call-out fee?",
  ...
  },
  {
    ...
    answer: 'We provide drainage services throughout <a href="/locations/aldershot/" class="text-primary hover:underline">Aldershot</a> and Hampshire, including <a href="/locations/farnham/" class="text-primary hover:underline">Farnham</a>, <a href="/locations/farnborough/" class="text-primary hover:underline">Farnborough</a>, <a href="/locations/fleet/" class="text-primary hover:underline">Fleet</a>, Camberley, Guildford, Ash, Yateley, and Sandhurst. See <a href="/locations/" class="text-primary hover:underline">all locations we cover</a>.'
  },
  {
