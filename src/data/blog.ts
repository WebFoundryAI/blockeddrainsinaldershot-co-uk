...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    metaTitle: "7 Warning Signs of a Blocked Drain | Call a Professional",
    metaDescription: "Learn the early warning signs of a blocked drain in Aldershot. From slow drainage to bad smells, know when to call a professional before it becomes an emergency.",
    excerpt: "Catching a blocked drain early can save you hundreds of pounds in emergency repairs. Here are the key warning signs every Aldershot homeowner should know.",
...
If you're experiencing a complete blockage, our [blocked drain specialists](/services/blocked-drains/) are available 24/7 across [Aldershot](/locations/aldershot/) and surrounding areas. For urgent situations, our [emergency drain service](/services/emergency-drain-services/) guarantees a rapid response.

Call us on ${BRAND.phoneFormatted} for a no-obligation quote, or [contact us online](/contact/) to book an appointment.`,
    author: "Blocked Drains in Aldershot",
  ...
  },
  {
    ...
    metaTitle: "Prevent Kitchen Drain Blockages | Aldershot Tips",
    metaDescription: "Stop kitchen drain blockages before they start. Expert tips on preventing grease buildup, food waste disposal, and maintaining clear drains in your Aldershot home.",
    ...
    content: `Kitchen drains handle more abuse than any other drain in your home. Between cooking oils, food scraps, soap residue, and everything else that goes down the sink, it's no wonder they're the most frequently blocked drains we see in Aldershot homes.
...
Contact ${BRAND.brandName} on ${BRAND.phoneFormatted} for expert advice and assistance, or [get in touch online](/contact/).`,
  ...
  },
  {
    ...
    metaTitle: "CCTV Drain Survey Before Buying | Aldershot Guide",
    metaDescription: "Buying a house in Aldershot? Discover why a pre-purchase CCTV drain survey could save you thousands and give you negotiating power.",
...
Many of our Aldershot customers have negotiated thousands off their purchase price after our surveys revealed drain problems the seller wasn't aware of.
...
At ${BRAND.brandName}, we provide comprehensive [pre-purchase drain surveys](/services/cctv-drain-surveys/pre-purchase-survey/) across [Aldershot](/locations/aldershot/) and Aldershot and surrounding areas. Our engineers explain exactly what they find and provide honest advice about any issues.
...
Book your [CCTV drain survey](/services/cctv-drain-surveys/) today by calling ${BRAND.phoneFormatted} or [contact us online](/contact/).`,
  ...
  },
  {
    ...
    metaTitle: "Emergency Drain Problems | Steps While Waiting for Help",
    metaDescription: "Experiencing a drain emergency in Aldershot? Learn what to do immediately to minimise damage while waiting for professional help to arrive.",
...
We aim to arrive within 1-2 hours for [emergency callouts across Aldershot](/locations/aldershot/emergency-drain-services/) and Aldershot and surrounding areas. Our [emergency drain services](/services/emergency-drain-services/) team is available 24 hours a day, 7 days a week.
...
Call us immediately on ${BRAND.phoneFormatted} if you're experiencing a drain emergency, or [request urgent help online](/contact/).`,
  ...
  },
  {
    ...
    metaTitle: "Drain Jetting vs Rods | Aldershot Comparison",
    metaDescription: "Should you use drain rods or high-pressure jetting to clear a blockage? Our Aldershot drainage experts explain when each method works best.",
...
When you call us for a blocked drain in Aldershot, we typically:
...
For reliable [drain clearing across Aldershot](/locations/aldershot/drain-jetting/), call ${BRAND.brandName} on ${BRAND.phoneFormatted} or [request a quote online](/contact/). We also cover [Farnham](/locations/farnham/), [Farnborough](/locations/farnborough/), and [Fleet](/locations/fleet/).`,
    author: "Blocked Drains in Aldershot",
